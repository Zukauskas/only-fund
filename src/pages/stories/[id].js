                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                ...
                                />
                                { story.sumNeeded - story.sumDonated > 0 ? (
                                    <form onSubmit={ submitHandler } className='space-y-4 mt-6'>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                id={ story.id }
                                                value={
                                                    +story.id === +enteredData.id ? enteredData.amount : ''
                                                }
                                    ...
                                    <p className='text-lg text-green-700 font-bold bg-green-200 text-center p-3 mt-6 rounded-lg'>This story is completed</p>
                                ) }
                            </div>
                            <div>
